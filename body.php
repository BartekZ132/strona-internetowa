						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">smartphony</a></li>
									<li><a data-toggle="tab" href="#tab1">aparaty</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">promocje tego tygodnia</h2>
							<p>nowa kolekcja 50% taniej</p>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">najczęściej kupowane </h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 col-xs-6">
						<div class="section-title">
							<h4 class="title">najczęściej kupowane</h4>
							<div class="section-nav">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="#">nazwa produktu</a></h3>
										<h4 class="product-price">980.00zł <del class="product-old-price">990.00zł</del></h4>
									</div>
								</div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">kategoria</p>
										<h3 class="product-name"><a href="#">nazwa produktu</a></h3>
										<h4 class="product-price">980.00zł <del class="product-old-price">990.00zł</del></h4>
									</div>
								</div>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Ckategoria</p>
										<h3 class="product-name"><a href="#">nazwa produktu</a></h3>
										<h4 class="product-price">980.00zł <del class="product-old-price">990.00zł</del></h4>
									</div>
								</div>
					...
					<div class="col-md-4 col-xs-6">
						<div class="section-title">
							<h4 class="title">najczęściej sprzedawane</h4>
							<div class="section-nav">
