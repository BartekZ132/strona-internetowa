			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="aside" class="col-md-3">
						...
						<div class="aside">
							<h3 class="aside-title">najczęsciej kupowane</h3>
					...
					<div id="store" class="col-md-9">
							...
							<div class="store-sort">
								<label>
									...
									<select class="input-select">
										<option value="0">popularne</option>
										<option value="1">pozycja</option>
									</select>
								</label>
						...
						<div class="store-filter clearfix">
							<span class="store-qty">pokaż 20-100 produktów</span>
